            ...
            <section class="panel">
                ...
                <form method="post" action="${pageContext.request.contextPath}/units/open"
                    ...
                    <section class="form-section">
                        <h3 class="form-section-title">单位基本信息</h3>
                        <div class="grid">
                    ...
                    <section class="form-section">
                        <h3 class="form-section-title">经办人信息</h3>
                        <div class="grid">
                            <div class="field">
                    ...
                    <section class="form-section">
                        <h3 class="form-section-title">缴存比例</h3>
                        <div class="grid">
                            <div class="field">
                                <label for="unitRatio">单位比例<span class="required">*</span></label>
                            ...
                            <div class="field">
                                <label for="perRatio">个人比例<span class="required">*</span></label>
